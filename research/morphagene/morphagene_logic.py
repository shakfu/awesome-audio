...
def main(argv):
    ...
    try:
        ...
        raise ValueError('Input .wav file %s is poorly formatted, exiting'%inputwavefile)
    ...
    print("Correcting input %i-bit bitdepth to Morphagene %i-bit float bitdepth"%(bits_per_sample,morpth_bd))
